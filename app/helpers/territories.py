...
async def bind_population_to_territories(
    ...
    #the reason why where is no popultaion in inner territories is because get_population_for_internal_territories 
    #doesnt return it for all lvls, but just one
